      ...
      <section id="dashboard">
        <div className="container bg-white text-lg mx-auto p-10 flex flex-col gap-10 items-center mb-10">
          ...
          <h2 className="text-6xl font-title text-mainDark">
            Hello Nata, Selamat datang
          </h2>
          <h5 className="text-xl text-mainDark">
            Semoga aktivitas mu menyenangkan,
          </h5>
        </div>
      </section>
      <section id="motivasi" className="bg-[#F4F5F7] p-20">
        <div className="container text-center bg-white text-[#494479] mx-auto p-16 px-[15%] rounded-3xl shadow-xl flex flex-col gap-6 items-center justify-center">
          <div className="flex gap-7">
            ...
            <h5 className="text-mainDark font-title text-5xl">
              Motivasi Hari ini
            </h5>
          </div>
          <p className="text-4xl italic px-4 pb-7">
            Anda tidak perlu mengendalikan pikiran Anda. Anda hanya harus
            berhenti membiarkan mereka mengendalikan Anda.
          </p>
          ...
          <div className="bg-[#F4F5F7] rounded-2xl p-12 grid grid-cols-5 gap-6">
            ...
            <div className="col-start-2 col-end-6 flex flex-col justify-around text-xl text-[#000000B2]">
              ...
              <div className="flex items-center gap-1 text-2xl">
                ...
                <span className="text-[#3D3F40]">1</span>
                <span className="text-[#989B9E] font-inter">tahun</span>
                <img src={RatingIcon} alt="Rating Icon" className="ml-4" />
                <span className="text-[#3D3F40] font-inter font-[600] tracking-[-0.3rem]">
                  4
                </span>
                <span className="font-inter text-[#989B9E]">/5</span>
              </div>
              <p>
                Lorem ipsum dolor, sit amet consectetur adipisicing elit. Veniam
                officia excepturi repellendus voluptas, consequuntur beatae
                exercitationem impedit voluptates expedita sint amet similique
                tempora, distinctio repellat commodi, esse id? Nostrum, natus!
              </p>
            </div>
            ...
            <div className="col-start-6 p-10 flex justify-center items-center">
              <button
                type="button"
                className="bg-mainBlue shadow-xl shadow-mainBlue/50 text-white text-2xl font-semibold py-5 px-8 rounded-md cursor-pointer hover:opacity-80 active:opacity-70 transition duration-300"
              >
                Lihat Selengkapnya
              </button>
            </div>
